...
- **Phase A:** Index+Formatierung pruefen
- **Phase E:** Notion+Hub-Konsistenz
- **Phase F:** Regel-Konsistenz (Schicht-1/2/3-Routing)
- **Phase G:** Recovery-Note-Update + Archiv-Rotation
...
- Memory-Quality-Score (Composite 40/25/15/10/10)
- Sprint-Ziel-Sprache (Kunden-Rolle, nie selbst "Ziel erreicht")
- Carry-Over-Pattern toxisch (Sprint 261 Eskalation)
- Tier-1-Budget <2700 Zeilen

## Cross-Reference

- Regel 51 Memory Quality + Review-Zyklen
- Regel 53 Research-Enforcement (Persona-Updates)
- `experte-knowledge-manager.md` — volle Persona
